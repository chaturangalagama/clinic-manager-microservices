...
import lk.microservices.microservice.one.bussiness.model.dto.UserIdDto;
...
//    }
//
    public static UserIdEntity mapToEntityUserId(UserIdDto userIdDto){
        if(userIdDto == null){
            return null;
        }
        if(userIdDto.getIdType() != null) {
            return new UserIdEntity(UserIdEntity.IdType.valueOf(userIdDto.getIdType().name()), userIdDto.getNumber());
        }
        return null;
    }

    public static UserIdDto mapToDtoUserId(UserIdEntity userIdEntity){
        if(userIdEntity == null){
            return null;
        }
        if(userIdEntity.getIdType() != null) {
            return new UserIdDto(UserIdDto.IdType.valueOf(userIdEntity.getIdType().name()), userIdEntity.getNumber());
        }
        return null;
    }
